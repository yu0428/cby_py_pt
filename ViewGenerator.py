...
class ViewGenerator:  # Response for generating user interface files(html file).
    def __init__(self):
        ...
        """
        self.login = """
            <a href="/cgi-bin/ViewManage.py?target_page=login">Login</a>
            """
        self.register = """
            <a href="/cgi-bin/ViewManage.py?target_page=register">Register</a>
            """
        self.uploadImage = """
            <a href="/cgi-bin/ViewManage.py?target_page=upload_image">Upload Image</a>
            """
        self.checkImage = """
            <a href="/cgi-bin/ViewManage.py?target_page=check_image">Check Image</a>
            """
        self.logout = """
            <a href="/cgi-bin/ViewManage.py?target_page=logout">Logout</a>
            """
    ...
    def register_page(self):
        ...
        register_form = """
            <form method="get" action="/cgi-bin/register.py">
                Name: <input type="text" name="name">
                <br>
